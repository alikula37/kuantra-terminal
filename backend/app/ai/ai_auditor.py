...
class AiTradeAuditor:
    ...
    def generate_audit_context(cls) -> Dict[str, Any]:
        ...
        return {
            "account_equity": compliance_state["current_equity"],
            "high_watermark": compliance_state["high_watermark"],
            "current_drawdown_pct": compliance_state["current_drawdown_pct"],
            "daily_loss_utilization_pct": compliance_state["rules"][0]["utilization_pct"],
            "overall_compliance_status": compliance_state["overall_status"],
            "total_trades_count": scorecard["total_trades"],
            "win_rate_pct": scorecard["win_rate"],
            "sqn": scorecard["sqn"],
            ...
            "avg_exit_efficiency_pct": mae_mfe_data["average_exit_efficiency_pct"],
            "recommended_target_r": mae_mfe_data["recommended_target_r"],
            "trades_left_money_on_table": mae_mfe_data["trades_left_money_on_table"],
            "total_panic_exit_leakage_dollars": drift_data["total_panic_exit_leakage"],
            "execution_fidelity_pct": drift_data["execution_fidelity_pct"],
            "session_tilt_score": tilt_state["tilt_score"],
            "tilt_status": tilt_state["status"],
            "consecutive_losses": tilt_state["consecutive_losses"],
            "revenge_trades_count": tilt_state["revenge_trades_count"],
            "fomo_trades_count": tilt_state["fomo_trades_count"],
            "fatigue_inflection_point": fatigue_state["inflection_point"],
            "performance_decay_pct": fatigue_state["performance_decay_pct"],
            "total_anomalies_count": anomalies_data["total_anomalies_count"]
        }
