...
class TestReleaseManifestAndPackaging:
    ...
    def test_release_notes_integrity(self, root_dir):
        ...
        assert "Kuantra Terminal v1.1.4 — Trusted macOS Pilot" in content
        assert "Kuantra-Terminal-1.1.4-arm64.dmg" in content
        assert "Kuantra-Terminal-1.1.4-x86_64.dmg" in content
        ...
        assert "docs/release/truth-matrix.v1.1.4.json" in content
    ...
    def test_manifest_generator_execution(self, root_dir, tmp_path):
        ...
        assert manifest["truth_matrix"]["version"] == "1.1.4"
