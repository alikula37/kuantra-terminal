...
| Mac (latest local evidence) | H07 source `da9af9b` passed clean arm64 locked local CI and exact read-only DMG/WKWebView smoke; DMG SHA `5a7c6dd40ba2a453ebbe9cbca3377cea4664d0829e06473ed00f3efeb30d5940`, exact smoke report SHA `7c5f74a3bb56baf53aa5acd27caf310cb206a2680759bab0ce08c5bc5d1afaf3`, mounted executable SHA `2e23dd2298ac5ae1406bb6203a23f0982353ca1b595b49251d34282205326a9b`; Developer ID/notarization/Gatekeeper/second-host evidence remains open |
| H07 bounded baseline | Code `da9af9b` on clean Mac arm64: 710 backend, 100 frontend, i18n 608/608, local CI `MERGE READY`; legacy and exact-coverage typed trade queries abort mid-stream at the cooperative resource boundary without returning partial results. Evidence Pack/Reconciliation Inbox/Weekly Review/CSV preview plus Dashboard/Quant Analytics/Header portfolio, JournalView trade-list, MAE/MFE, SettingsView portfolio-summary, Charts/TradingViewChart historical OHLCV and plugin registry/ModStore read surfaces have bounded AbortSignal, stale-response suppression and explicit loading/error truth; malformed successful payloads fail closed, unavailable analytics never becomes a zero scorecard/empty journal/chart, historical candles never become synthetic live ticks, Settings never falls back to zero balance, and malformed registry metadata never becomes capability. Append-only ledger verification now reuses only an unchanged `PRAGMA data_version` snapshot and fully rechecks after append/commit. Exact DMG/WKWebView smoke is PASS with provenance COMPLETE: report `7c5f74a...`, DMG `5a7c6dd...`, mounted executable `2e23dd2...`; local CI report `1a2544a...`, `.app` `ed97602...`. Current artifact-bound 100k Evidence Pack p95 `4132.1722 ms` (cold first verification included), cache-warm export p95 `329.0577 ms`, projection rebuild p95 `8093.7152 ms`, max operation RSS `335.4219 MB`; the `<2s` planning target is not met and H07 remains `IMPLEMENTATION_REQUIRED` |
...
read truth fixtures and `da9af9b` unchanged-ledger verification cache are present.
Exact Mac arm64 app/DMG/WKWebView evidence is tied to code baseline `da9af9b`;
local CI report SHA
`1a2544ae69c715ba71536befd84d08eeca9883b6aa9b4eb4a98e5e7e472c5795`, exact DMG
smoke report SHA `7c5f74a3bb56baf53aa5acd27caf310cb206a2680759bab0ce08c5bc5d1afaf3`,
mounted executable SHA `2e23dd2298ac5ae1406bb6203a23f0982353ca1b595b49251d34282205326a9b`
and DMG SHA `5a7c6dd40ba2a453ebbe9cbca3377cea4664d0829e06473ed00f3efeb30d5940`.
The exact 100k report SHA is
`3d2f3218f691b36fdcfc7fabb31b8bdbde614d66b784ef211d2208f64431ef55`; cold Evidence
Pack and projection rebuild p95 values do not meet the planning target, so H07
remains `IMPLEMENTATION_REQUIRED`. Safe-persona read surfaces listed in the H07
work package have current bounded evidence; auxiliary and disabled surfaces are not
promoted. Next handoff is a cold-path projection/Evidence Pack budget audit.
