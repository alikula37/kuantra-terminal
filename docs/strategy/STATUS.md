...
| Mac (latest local evidence) | H07 source `f551b1f` passed clean arm64 locked local CI and exact read-only DMG/WKWebView smoke; DMG SHA `65e7da9933dcae78cf5d33045468d05dffda74fd8e4a73753b70487692db4895`, exact smoke report SHA `e083ad5de417f84e2d3d50428af4416890505036a3dd4e802231f96818173af8`, mounted executable SHA `4a9da326153f08c0ec937f5dd68581a76886031dacdb35f60f5822c69a463ab2`; Developer ID/notarization/Gatekeeper/second-host evidence remains open |
| H07 bounded baseline | Code `f551b1f` on clean Mac arm64: 712 backend, 100 frontend, i18n 608/608, local CI `MERGE READY`; legacy and exact-coverage typed trade queries abort mid-stream at the cooperative resource boundary without returning partial results. Evidence Pack/Reconciliation Inbox/Weekly Review/CSV preview plus Dashboard/Quant Analytics/Header portfolio, JournalView trade-list, MAE/MFE, SettingsView portfolio-summary, Charts/TradingViewChart historical OHLCV and plugin registry/ModStore read surfaces have bounded AbortSignal, stale-response suppression and explicit loading/error truth; malformed successful payloads fail closed, unavailable analytics never becomes a zero scorecard/empty journal/chart, historical candles never become synthetic live ticks, Settings never falls back to zero balance, and malformed registry metadata never becomes capability. Append-only ledger verification reuses only an unchanged `PRAGMA data_version` snapshot, projection rebuild reuses that verifier, and apply rebuild releases the verifier connection to prevent WAL growth. Exact DMG/WKWebView smoke is PASS with provenance COMPLETE: report `e083ad5...`, DMG `65e7da9...`, mounted executable `4a9da32...`; local CI report `e114e7d...`, `.app` `0e6b690...`. Current artifact-bound 100k Evidence Pack p95 `4162.4495 ms` (cold first verification included), cache-warm export p95 `328.6605 ms`, projection rebuild p95 `6159.2185 ms`, max operation RSS `335.3438 MB`, temporary disk `0 B` for projection rebuild; the `<2s` planning target is not met and H07 remains `IMPLEMENTATION_REQUIRED` |
...
read truth fixtures, `da9af9b` unchanged-ledger verification cache, `2da9fe1`
projection verifier reuse and `f551b1f` post-write connection release are present.
Exact Mac arm64 app/DMG/WKWebView evidence is tied to code baseline `f551b1f`;
local CI report SHA
`e114e7d074123fcf8efb1d2ababd921141a93f69005325fda52d5010fa946e9a`, exact DMG
smoke report SHA `e083ad5de417f84e2d3d50428af4416890505036a3dd4e802231f96818173af8`,
mounted executable SHA `4a9da326153f08c0ec937f5dd68581a76886031dacdb35f60f5822c69a463ab2`
and DMG SHA `65e7da9933dcae78cf5d33045468d05dffda74fd8e4a73753b70487692db4895`.
The exact 100k report SHA is
`524954428e4a63ddca4620daaa8e1e78562f66b48f425685f58c71e24f48b6a1`; cold Evidence
Pack p95 still does not meet the planning target, while projection rebuild p95 is
`6159.2185 ms` with `0 B` temporary-disk growth in the rebuild operation. H07 remains
