...
Owner-approved addition (2026-09-15): P1-WP37 multi-select journal filters and one-click unit declaration (`docs/strategy/work-packages/P1-WP37-journal-filters-and-unit-declaration.md`) — filters must multi-select and unverifiable instruments must be declarable in one step.
...
as the `pilot-v1.1.1` prerelease whose tag points at the verified build commit; the former
...
the tag on the verified build commit). The former `pilot-v1.1.3` release keeps its historical
1.1.3 packages and redirects users to v1.1.4. The canonical product Release/tag is not moved.
