...
mevcut güvenlik kapıları geçerlidir. P1-WP16, P1-WP17 ve P1-WP18 bounded doğruluk paketleri
kanıtla kapatılmıştır; mevcut `Ready` iş P1-WP19'dur. Aşağıdaki
...
`D03 / P1-WP18` kanıtla kapatılmıştır; `D04 / P1-WP19` mevcut bounded iştir. Sonraki işler hazır
...
| D04 / P1-WP19 | Funding/corrections/account reconciliation kapsamı | Opening position/balance; realized/unrealized ayrımı; funding time; transfer ≠ PnL; liquidation/ADL varsa explicit event veya unsupported | D03; P1-WP18 |
...
security reviewer ve operasyon sorumlusu. Bugün bunların eksikliği P1-WP19 fixture
...
4. P1-WP19: funding/corrections/account coverage; ardından D05–06.
5. D05–06: ekonomik dedup/lifecycle ve journal/evidence bağlantısı.
6. U01–05; paralelde H01–07/N01–06 bağımlılığa göre; sonra kapalı pilot.
