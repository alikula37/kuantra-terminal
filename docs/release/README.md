...
[`truth-matrix.v1.1.3.json`](truth-matrix.v1.1.3.json). The matrix is a contract, not a
...
The current release train targets v1.1.3 on macOS 12+ with separate native arm64 and x86_64
artifacts; v1.1.3 adds the journal bulk CSV export and readable PDF reports (explicit
filtered/all scope, Europe/Istanbul period with entry/close basis, separated
...
[`pilot-v1.1.3`](https://github.com/alikula37/kuantra-terminal/releases/tag/pilot-v1.1.3)
...
directs users to `pilot-v1.1.3`. The previous
...
`pilot-v1.1.3` tag is a private prerelease transport identifier, not a canonical product
...
The current matrix is `KTR-001@1.1.3`. The prior `KTR-001@1.0.1` matrix remains as
