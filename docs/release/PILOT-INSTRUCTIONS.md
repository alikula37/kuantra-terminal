# Kuantra Terminal v1.1.6 — kapalı macOS pilotu

**Güncel pilot Release:** [`pilot-v1.1.6`](https://github.com/alikula37/kuantra-terminal/releases/tag/pilot-v1.1.6)<br>
...
4. İndirdiğiniz DMG'nin disk-imaj bütünlüğünü mount etmeden önce doğrulayın:
   ...
   ```text
   hdiutil verify Kuantra-Terminal-1.1.6-<architecture>.dmg
   ```
...
```text
gh release view pilot-v1.1.6 --repo alikula37/kuantra-terminal
```
...
1.1.6 öncesi kurulumlarda bu düğme daha eski bir sayfayı açabilir; bu durumda bir defalık
