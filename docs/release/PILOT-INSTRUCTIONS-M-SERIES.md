...
ve local audit paketinde tutulur. Güncel Release indirme alanı pilot kullanıcılarının
kafasını karıştırmamak için yalnızca DMG içerir.

Bu belge repository içindeki pilot talimatıdır; Release body içindeki bağlantıdan
...
3. DMG container bütünlüğünü mount etmeden kontrol edin:
...
Şunları gönderin: paket sürümü, DMG dosya adı, `hdiutil verify`
