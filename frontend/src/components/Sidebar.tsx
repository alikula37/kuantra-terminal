...
import { LayoutDashboard, BookOpen, BarChart3, Crosshair, ShieldCheck, Layers, PlayCircle, BookmarkCheck, GitCommit, Brain, Bot, Sliders, Database, Cpu, Layout, Zap, Activity, Users, Flame, Terminal, Share2, Copy, Smartphone, Code, ArrowRightLeft, AlignJustify } from "lucide-react";

export type NavTab = "dashboard" | "fix_studio" | "dex_arbitrage" | "mcp_explorer" | "reverse_skill" | "docking" | "virtual_journal" | "journal" | "orderflow" | "fix_dma" | "p2p_mesh" | "copy_trading" | "mobile_companion" | "replay" | "playbook" | "drift" | "psychology" | "biometrics" | "ai_coach" | "swarm" | "analytics" | "mae_mfe" | "prop_shield" | "pivot_grid" | "settings";
